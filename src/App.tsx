...
const ENGINE_DEFS: Record<EngineId, EngineDef> = {
  ifclite: { id: 'ifclite', title: 'IFClite', subtitle: 'WebGPU', accent: 'ifclite', kind: 'canvas' },
...
// ---------------------------------------------------------------------------
// Comparison table (engines side by side, in run order)
// ---------------------------------------------------------------------------
...
export default function App() {
  ...
  const elRefs: Record<EngineId, React.RefObject<HTMLCanvasElement | null> | React.RefObject<HTMLDivElement | null>> = {
    ifclite: ifcLiteCanvasRef,
    thatopen: thatOpenHostRef,
  };
  const adapterRefs: Record<EngineId, React.MutableRefObject<ViewerAdapter | null>> = {
    ifclite: ifcLiteAdapterRef,
    thatopen: thatOpenAdapterRef,
  };

  const sIfc = useViewerState('IFClite');
